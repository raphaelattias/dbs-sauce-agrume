...
/* QUESTION 1
SELECT EXTRACT(YEAR FROM C.COLLISION_DATE), COUNT(C.COLLISION_DATE) FROM COLLISION C GROUP BY EXTRACT(YEAR FROM C.COLLISION_DATE)
*/
...
*/
 ...
 /* Question 6 
 SELECT C.WEATHER_1, C.WEATHER_2,COUNT(*) as count FROM COLLISION C GROUP BY (C.WEATHER_1,C.WEATHER_2) ORDER BY COUNT DESC 
